...
class PointView: UIView {
    ...
    var isError: Bool {
        ...
        set {
            _isError = newValue
            if _isError {
                centerLayer.fillColor = UIColor.init(red: 222/255, green: 64/255, blue: 60/255, alpha: 1.0).cgColor
            } else {
                centerLayer.fillColor = UIColor.init(red: 30/255, green: 180/255, blue: 244/255, alpha: 1.0).cgColor
            }
        }
    }
    var isSuccess: Bool {
        ...
        set {
            _isSuccess = newValue
            if _isSuccess {
                centerLayer.fillColor = UIColor.init(red: 43/255, green: 210/255, blue: 110/255, alpha: 1.0).cgColor
            } else {
                centerLayer.fillColor = UIColor.init(red: 30/255, green: 180/255, blue: 244/255, alpha: 1.0).cgColor
            }
        }
